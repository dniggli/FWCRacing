...
Public Class DriverUpdateForm
    ...
    Sub saveupdate()
        ...
        If ComboBox1.Text = "F1" Then
            ...
            Dim comm As New MySqlCommand("update fantasy_race.f1 set F1Driver = '" & TextBoxDriver.Text & "',Class = '" & TextBoxClass1.Text & "' where TeamNumber = '" & teamdict(TextBoxTeam.Text) & "'", New MySqlConnection("server=" & Form1.server & ";uid=root;pwd=vvo084;"))
        ...
        If ComboBox1.Text = "Indy" Then
            ...
            Dim comm As New MySqlCommand("update fantasy_race.indy set IndyDriver = '" & TextBoxDriver.Text & "',Class = '" & TextBoxClass1.Text & "' where TeamNumber = '" & teamdict(TextBoxTeam.Text) & "'", New MySqlConnection("server=" & Form1.server & ";uid=root;pwd=vvo084;"))
        ...
        If ComboBox1.Text = "Nascar" Then
            ...
            Dim comm As New MySqlCommand("update fantasy_race.nascara set NasCarADriver = '" & TextBoxDriver.Text & "',Class = '" & TextBoxClass1.Text & "' where TeamNumber = '" & teamdict(TextBoxTeam.Text) & "'", New MySqlConnection("server=" & Form1.server & ";uid=root;pwd=vvo084;"))

            comm.Connection.Open()
            comm.ExecuteNonQuery()
            comm.Connection.Close()

            Dim comm1 As New MySqlCommand("update fantasy_race.nascarb set NasCarbDriver = '" & TextBoxDriver2.Text & "',Class = '" & TextBoxClass2.Text & "' where TeamNumber = '" & teamdict(TextBoxTeam.Text) & "'", New MySqlConnection("server=" & Form1.server & ";uid=root;pwd=vvo084;"))
