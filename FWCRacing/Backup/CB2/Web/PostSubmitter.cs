...
*/
    ...
    public class PostSubmitter
    {
        ...
        private List<KeyValuePair<string,string>> m_values = new List<KeyValuePair<string,string>>();
        ...
        public PostSubmitter(string url, List<KeyValuePair<string,string>> values)
            : this(url)
        {
            m_values = values;
        }
        ...
        /// </summary>
        public List<KeyValuePair<string,string>> PostItems
        {
            get
            {
                return m_values;
        ...
        /// <summary>
        /// Gets or sets the UserName to log into the url
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the password to log into the url
        /// </summary>
        ...
        public string Post()
        {
            ...
            {
                EncodeAndAddItem(ref parameters, m_values[i].Key, m_values[i].Value);
            }
        ...
        /// <returns>a string containing the result of the post.</returns>
        public string Post(string url, List<KeyValuePair<string,string>> values)
        {
            m_values = values;
