...
Module GetNascarx
    ...
    'Sub getnewnascar(ByVal url As String)
    ...
    Sub getnascarinfo(ByVal url As String)
        ...
        NewFunctions.GetNewNascar(url, "X")
        ...
        '    Dim circut As String = Form1.TextBoxnascarxC.Text
        ...
        '            Console.WriteLine(list(list1).Trim)

        '            If list(list1).ToUpper.Contains("#") Then
        '                Dim n2 As Integer = 9
        '                list0 = list0 + n2
        '                list1 = list1 + n2
        '                list2 = list2 + n2
        ...
        '                Dim comm As New MySqlCommand("insert into fantasy_race.nascarresults(position,driver,laps,pollgrid,circut,running,stagewin) Values ('" & list(list0) & "','" & list(list1).Trim & "','" & list(list5) & "','" & list(list3) & "','" & circut & "','" & list(list6) & "','X')", New MySqlConnection("server=" & Form1.server & ";uid=dave;pwd=vvo084;"))
